...
static const char DINMETER_FW_MARKER[] __attribute__((used)) =
  "DINMETER_FW_VERSION=v1.9.3-dev";
#include <M5Unified.h>
#include <M5_ANGLE8.h>
...
void drawSystemInfo() {
  ...
  M5.Display.print("FW          : v1.9.3-dev");
...
void drawWifiRuntimeScreen() {
  ...
  if (wifiMaintStaConnected()) {
    M5.Display.print("FW v1.9.3-dev  LATEST ");
...
void synthAppSetup() {
  ...
  snprintf(overlayTitle, sizeof(overlayTitle), "DIN SYNTH v1.9.3-dev");
