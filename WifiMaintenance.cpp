...
static constexpr const char* CURRENT_FW_VERSION = "v1.10.10";
...
bool fetchLatestGithubRelease() {
  ...
  // v1.10.10 uses GitHub's release SHA-256 digest for payload integrity.
...
String rootPage() {
  ...
  h += F("<div class='verrow'><span class='verlabel'>CURRENT</span><span id='ghCurrent' class='vervalue'>v1.10.10</span></div>");
  ...
  h += F("<div class='verbox'>");
  h += F("<div class='verrow'><span class='verlabel'>CURRENT</span><span id='currentVersion' class='vervalue'>v1.10.10</span></div>");
  ...
  h += F("const CURRENT_VERSION='v1.10.10';");
...
void registerWebRoutes() {
  ...
  server.on("/health", HTTP_GET, []() {
    ...
    server.send(200, "application/json; charset=utf-8",
                "{\"ok\":true,\"version\":\"v1.10.10\"}");
  });

  server.on("/github-status", HTTP_GET, []() {
    String j = "{\"current\":\"v1.10.10\",\"latest\":\"";
